...
import org.firstinspires.ftc.teamcode.Autonomouse.REDRIGHTREAL;
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        super(kV, kA, kStatic, TRACK_WIDTH, TRACK_WIDTH, LATERAL_MULTIPLIER);
            ...
            follower = new HolonomicPIDVAFollower(TRANSLATIONAL_PID, TRANSLATIONAL_PID, HEADING_PID,
                    new Pose2d(0.25, 0.25, Math.toRadians(0.2)), 0.75);
//            follower = new HolonomicPIDVAFollower(TRANSLATIONAL_PID, TRANSLATIONAL_PID, HEADING_PID,
//                    new Pose2d(0.5, 0.5, Math.toRadians(0.2)), 0.5);
        ...
        leftRear = hardwareMap.get(DcMotorEx.class, ConfigurationName.leftRear);
        rightRear = hardwareMap.get(DcMotorEx.class, ConfigurationName.rightRear);
